...
import 'package:booktickets/widgets/thick_cointainer.dart';
                              ...
                              builder: (BuildContext context, BoxConstraints constraints) {
                                ...
                                return Flex(
                                  ...
                                  children: List.generate((constraints.constrainWidth()/6).floor(), (index) =>  SizedBox (
                                    width: AppLayout.getWidth(1), height: AppLayout.getHeight(1), child: DecoratedBox(decoration: BoxDecoration(
                                      color: Colors.white
                                  ),),
                                  )),
                                );
